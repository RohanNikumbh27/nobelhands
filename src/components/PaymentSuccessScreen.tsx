...
export function PaymentSuccessScreen({
    ...
    if (navigator.share) {
      navigator.share({
        ...
        setAlertState({
          isOpen: true,
          title: "Share Failed",
          message: "Share feature not available. You can manually share your contribution!"
        });
      });
    } else {
      setAlertState({
        isOpen: true,
        title: "Not Supported",
        message: "Share feature not available on this device."
      });
    }
  };
  ...
  const handleDownloadReceipt = () => {
    setAlertState({
      isOpen: true,
      title: "Coming Soon",
      message: "Receipt download feature will be available in the production version. You'll receive a receipt via email."
    });
  };
